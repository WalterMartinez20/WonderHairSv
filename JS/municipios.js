...
departamento.addEventListener('change', (e) => {
    if (municipios[parseInt(e.target.value)]) {
        municipio.disabled = false;
        municipio.innerHTML = "";
        var opcionDefault = document.createElement("option");
        opcionDefault.text = "Seleccione un municipio";
        opcionDefault.value = "";
        municipio.add(opcionDefault);
        municipios[e.target.value].forEach((item, index) => {
